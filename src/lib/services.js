export const servicesContent = [
  {
    heading: "Antya Sanskar / Antyeshthi / Last cremation rites",
    content: [
      ...
      //   {
      //     sub: "* In Australia we simulate this by lighting the incense stick and touch the flame to the lips, chest and the legs of the body. Just before the coffin goes into the furnace, we light a mud lamp with ghee and wick and place it on the lid of the coffin near the chest area.",
      //   },
    ],
  },
  {
    heading: "Sanchayanam (Immersion of the ashes)",
    content: [
