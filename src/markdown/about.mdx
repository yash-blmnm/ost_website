...
<div className="flex flex-row gap-x-2 items-stretch justify-between w-full text-center	">
    <div className="flex flex-col items-center team-member-item">
        <img className="team-image" src="images/members/raman.png" width="100" height="100" />
        <div>
    ...
    <div className="flex flex-col items-center team-member-item">
        <img className="team-image" src="images/members/mahesh.png" width="100" height="100" />
        <div>
    ...
    <div className="flex flex-col items-center team-member-item">
        <img className="team-image" src="images/members/maheshwaran.png" width="100" height="100" />
        <div>
    ...
    <div className="flex flex-col items-center team-member-item">
        <img className="team-image" src="images/members/balaKrishna.png" width="100" height="100" />
        <div>
    ...
    <div className="flex flex-col items-center team-member-item">
        <img className="team-image" src="images/members/shankeranarayan.png" width="100" height="100" />
        <div>
...
<div className="flex flex-row gap-x-2 items-stretch	justify-between  w-full text-center	">
    <div className="flex flex-col items-center team-member-item team-member-item">
        <img className="team-image" src="images/members/suthakar.png" width="100" height="100" />
        <div>
    ...
    <div className="flex flex-col items-center team-member-item">
        <img className="team-image" src="images/members/ramesh.png" width="100" height="100" />
        <div>
    ...
    <div className="flex flex-col items-center team-member-item">
        <img className="team-image" src="images/members/radhakrishnan.png" width="100" height="100" />
        <div>
    ...
    <div className="flex flex-col items-center team-member-item">
        <img className="team-image" src="images/members/srikanth.png" width="100" height="100" />
        <div>
    ...
    <div className="flex flex-col items-center team-member-item">
        <img className="team-image" src="images/members/paresh.png" width="100" height="100" />
        <div>
